...
// Sukebei 实现通过 Sukebeiapi.onrender.com 进行搜索的适配器
type Sukebei struct {
    endpoint string
    headers  http.Header
    client   *http.Client
...
func (n *Sukebei) ID() string          { return "Sukebei" }
func (n *Sukebei) Name() string        { return "Sukebei" }
func (n *Sukebei) Description() string { return "通过 Nyaaapi.onrender.com 提供的 API 检索资源" }
func (n *Sukebei) Endpoint() string    { return n.endpoint }

// Search 执行搜索
func (n *Sukebei) Search(ctx context.Context, term string) ([]models.SearchResult, error) {
