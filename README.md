...
🚀 **支持Docker容器化部署**，可轻松部署到Render、Heroku等免费托管服务！

🔐 **可选密码保护功能**，通过环境变量设置访问密码，保护你的服务不被随意访问。
...
1. 将代码推送到GitHub
2. 在[Render](https://render.com)创建Web Service
3. 使用`render.yaml`自动配置，或手动设置：
